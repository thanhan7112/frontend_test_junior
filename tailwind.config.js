  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gray-gradient-4": "linear-gradient(180deg, rgba(255, 255, 255, 0.8) 0%, rgba(207, 207, 207, 0.5) 47%, rgba(255, 255, 255, 0.8) 100%)",
        ...
        "blue-gradient-4": "linear-gradient(180deg, #1E94F4 0%, #0621CE 100%)",
