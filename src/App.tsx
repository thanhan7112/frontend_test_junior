                      ...
                      <div className="flex absolute z-10 bottom-5 items-center justify-center h-full">
                          ...
                          {[Glow1, Glow2].map((e) => (
                              ...
                              />
                                        ...
                                        <div className="flex flex-col items-center z-50 justify-end bottom-0 cursor-pointer w-fit h-full" onClick={() => setSelectedInf(tier.tierNum)}>
                                            {selectedInf === tier.tierNum && <div className="w-full relative z-50 grow flex flex-col justify-end">
                                                <div className={'size-[6px] mb-[14px] border shadow-lg mx-auto border-neutral-fg-blue-4-rest rounded-full bg-white'}></div>
                                                <div className="relative w-full flex justify-center">
                                                    <div className={`absolute -top-3 ${selectedInf === 6 ? 'right-0' : selectedInf === 1 ? 'left-0' : 'left-1/2 -translate-x-1/2'
                                                    } w-fit z-50 flex flex-col p-1 glass border-custom rounded border-gradient-border`}>
